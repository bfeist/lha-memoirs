...
**Before completing any task, you MUST run the verification command:**
...
**Do not consider work complete until this command passes without errors.** If errors occur, fix them and re-run until the command succeeds.

### Use Subagents for Complex Tasks

When faced with complex, multi-step tasks that require:

- Extensive research or file exploration
- Parallel investigations across multiple areas
- Specialized knowledge gathering before implementation
- Complex debugging or analysis

**Use the `runSubagent` tool to delegate the task** rather than attempting it yourself. This allows:
